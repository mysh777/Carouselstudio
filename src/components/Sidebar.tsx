import { Images, Palette, Layers, LogOut, FolderKanban, Settings as SettingsIcon } from 'lucide-react';
    ...
    <aside className="w-64 bg-white border-r border-slate-200 flex flex-col">
      ...
      <div className="p-4 border-t border-slate-200">
        <button
          ...
          className="w-full flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-slate-700 hover:bg-slate-100 mb-2"
        >
