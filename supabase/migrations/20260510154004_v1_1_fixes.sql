...
VALUES
  ('carousel-photos', 'carousel-photos', false, 10485760, ARRAY['image/jpeg','image/png','image/webp','image/heic','image/heif','application/octet-stream']::text[]),
  ('fonts', 'fonts', false, 5242880, ARRAY['font/woff2','font/woff','font/ttf','font/otf','font/sfnt','application/x-font-ttf','application/x-font-woff','application/x-font-woff2','application/font-woff2','application/octet-stream']::text[])
